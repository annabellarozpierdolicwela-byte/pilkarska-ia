...
EXACT_ENGINE_VERSION = "31.0-UDINESE-LAZIO-ELCHE-REAL-SOCIEDAD"
...
def _load_targeted_exact_history(existing):
    ...
    try:
        ...
        targets = ["Udinese", "Lazio", "Elche", "Real Sociedad"]
...
def _manual_exact_watch_fixtures():
    ...
    return pd.DataFrame([
        {"home": "Udinese", "away": "Lazio", "league": "Serie A", "date": None},
        {"home": "Elche", "away": "Real Sociedad", "league": "LaLiga", "date": None},
    ])
