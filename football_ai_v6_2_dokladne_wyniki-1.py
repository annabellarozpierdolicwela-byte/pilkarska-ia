...
def make_predictions():
    ...
    for _, r in upcoming_df.iterrows():
        ...
        # Never hide a real upcoming fixture only because the historical
        # sample is small. The model has league-average fallback priors.
        if MIN_TEAM_HISTORY > 0 and (
            p["matches_home"] < MIN_TEAM_HISTORY
            or p["matches_away"] < MIN_TEAM_HISTORY
        ):
            continue
