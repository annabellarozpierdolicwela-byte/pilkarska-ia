...
EXACT_ENGINE_VERSION = "47.0-FLASHCORE-APIFY-20H-20A-H2H-TOP5-TOP7"
...
def _manual_test_fixtures():
    ...
    today = now().date()
    rows = [
        {"home": "Botafogo", "away": "Bragantino", "league": "Argentina", "status": "NS", "date": f"{today}T19:00:00+00:00", "source": "manual-test"},
        {"home": "Santos", "away": "Cruzeiro", "league": "Argentina", "status": "NS", "date": f"{today}T21:00:00+00:00", "source": "manual-test"},
    ]
...
def _manual_exact_watch_fixtures():
    ...
    return pd.DataFrame([
        {"home": "Botafogo", "away": "Bragantino", "league": "Argentina", "date": None},
        {"home": "Santos", "away": "Cruzeiro", "league": "Argentina", "date": None},
    ])
