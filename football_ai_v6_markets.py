...
def add_market_analysis(chosen):
    ...
    # Player data is optional and never blocks the core model.
    enrich_scorers(chosen)
    # Do not require bookmaker odds for prediction. If API budget allows,
    # expose them as additional context.
