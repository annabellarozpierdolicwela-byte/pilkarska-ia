...
EXACT_ENGINE_VERSION = "59.0-BRAZIL-SERIE-B-FLASHscore-25MATCHES-STATS-SCORERS-4TEAMS-H2H"
...
#
# Current verified 2026 snapshots:
...
# MANUAL FLASHscore LAST-25 TEAM HISTORY (2026)
...
def exact_score_intelligence_rank(pred, context=None):
    ...
    # v26: do not let the first three slots become permanently dominated by
...
def predict(df, home, away, league=None, match_date=None):
    ...
    recent_all = pd.concat([
        recent_team_matches(df, home, n=20, before=match_date),
        recent_team_matches(df, away, n=20, before=match_date),
