...
EXACT_ENGINE_VERSION = "17.0-FULL-ENSEMBLE"
...
# v21: advanced signals discussed as plausible extensions of the observed
...
def _tail_mass_adjustment(score_h, score_a, base_prob, all_rows):
    """
    Hidden v21 signal: compare the candidate with the total probability mass
...
def exact_score_intelligence_rank(pred, context=None):
    """
    v21 Exact Score engine: BASELINE -> AI RANKING -> AI LIFT, modeled on the observed score table format.
    ...
    for item in base:
        ...
        # v21 Monte-Carlo cross-check. It does not replace the analytical model.
    ...
    # v21: do not let the first three slots become permanently dominated by
...
def predict(df, home, away, league=None, match_date=None):
    ...
    # v21: high-score / long-tail signal. It is evidence-driven, not a forced
...
def process_exact_watch(chat_id=None, update=False):
    ...
    if len(all_predictions) < 2:
        ...
        send(
            ...
            f"⚠️ Błędy pojedynczych analiz: {errors}/4\n"
