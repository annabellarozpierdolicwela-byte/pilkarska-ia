...
EXACT_ENGINE_VERSION = "56.0-BRAZIL-SERIE-B-FLASHscore-LAST10-STATS-SCORERS-4TEAMS-32H-32A-H2H"
...
# MANUAL FLASHscore LAST-10 TEAM HISTORY (2026)
# Inserted from the latest completed Serie B matches visible on Flashscore/team result pages,
# cross-checked against public match logs. These rows are intentionally local/static so /typy
