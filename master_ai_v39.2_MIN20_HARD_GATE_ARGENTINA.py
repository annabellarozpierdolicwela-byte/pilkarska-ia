...
API_DAILY_BUDGET = int(os.getenv("API_DAILY_BUDGET", "60"))
...
def _exact_watch_predictions(history):
    ...
    for _, r in fixtures.iterrows():
        try:
            ...
            # HARD MIN20 QUALITY GATE: do not publish an exact-score signal
            # unless the database really contains at least 20 HOME + 20 AWAY
            # matches for BOTH teams. We never manufacture or silently replace
            # missing venue history with global records.
