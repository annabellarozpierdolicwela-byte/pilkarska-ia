...
EXACT_ENGINE_VERSION = "41.0-ARG-EXACT-20H-20A-H2H-TOP5-TOP7-FINAL"
...
def process_exact_watch(chat_id=None, update=False):
    ...
    if not combinations:
        send("❌ Nie udało się zbudować kombinacji dokładnych wyników — brak poprawnych kandydatów SCORE w jednej z 2 analiz. Sprawdź diagnostykę powyżej.", chat_id)
        return False
