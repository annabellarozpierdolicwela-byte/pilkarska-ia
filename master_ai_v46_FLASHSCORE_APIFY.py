...
EXACT_ENGINE_VERSION = "46.0-FLASHCORE-APIFY-20H-20A-H2H-TOP5-TOP7"
...
def _apify_fetch_target_history(force=False):
    ...
    try:
        ...
        target_keys = {norm_team(x) for x in [
            "Boca Juniors", "Central Cordoba", "Gimnasia Y Tiro de Salta", "Tristan Suarez"
        ]}
...
def _load_targeted_exact_history(existing):
    ...
    try:
        ...
        targets = ["Boca Juniors", "Central Cordoba", "Gimnasia Y Tiro de Salta", "Tristan Suarez"]
...
def _manual_test_fixtures():
    ...
    today = now().date()
    rows = [
        {"home": "Boca Juniors", "away": "Central Cordoba", "league": "Argentina", "status": "NS", "date": f"{today}T19:00:00+00:00", "source": "manual-test"},
        {"home": "Gimnasia Y Tiro de Salta", "away": "Tristan Suarez", "league": "Argentina", "status": "NS", "date": f"{today}T21:00:00+00:00", "source": "manual-test"},
    ]
...
def _manual_exact_watch_fixtures():
    ...
    return pd.DataFrame([
        {"home": "Boca Juniors", "away": "Central Cordoba", "league": "Argentina", "date": None},
        {"home": "Gimnasia Y Tiro de Salta", "away": "Tristan Suarez", "league": "Argentina", "date": None},
    ])
