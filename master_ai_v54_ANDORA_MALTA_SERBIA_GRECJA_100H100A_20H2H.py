...
EXACT_ENGINE_VERSION = "54.0-ANDORA-MALTA-SERBIA-GRECJA-100H100A-20H2H-TOP5-TOP7"
...
# ============================================================
# MASTER OF AI — INTERNATIONAL NATIONAL-TEAM HISTORY v54
# ============================================================
...
def _load_targeted_exact_history(existing):
    ...
    for a_name, b_name in (("Andorra", "Malta"), ("Serbia", "Greece")):
...
def _manual_exact_watch_fixtures():
    ...
    return pd.DataFrame([
        {"home": "Andorra", "away": "Malta",
         "league": "UEFA Nations League D", "date": "2026-09-24T18:00:00+02:00"},
        {"home": "Serbia", "away": "Greece",
         "league": "UEFA Nations League A", "date": "2026-09-24T20:45:00+02:00"},
    ])
