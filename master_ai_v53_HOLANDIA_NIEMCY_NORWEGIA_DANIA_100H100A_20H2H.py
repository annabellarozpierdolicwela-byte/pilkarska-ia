...
EXACT_ENGINE_VERSION = "53.0-HOLANDIA-NIEMCY-NORWEGIA-DANIA-100H100A-20H2H-TOP5-TOP7"
...
# ============================================================
# MASTER OF AI — INTERNATIONAL NATIONAL-TEAM HISTORY v53
# ============================================================
...
def _load_targeted_exact_history(existing):
    ...
    for a_name, b_name in (("Netherlands", "Germany"), ("Norway", "Denmark")):
