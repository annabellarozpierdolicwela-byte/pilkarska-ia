...
EXACT_ENGINE_VERSION = "49.0-BRAZIL-SERIE-B-JUVENTUDE-ATHLETIC-NOVORIZONTINO-CUIABA-20H-20A-H2H"
...
def _load_targeted_exact_history(existing):
    ...
    for team in targets:
        ...
        log.warning("FLASHSCORE MIN20 PREFLIGHT %s => HOME=%d AWAY=%d", team, hh, aa)
